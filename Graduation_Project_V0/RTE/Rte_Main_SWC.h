 ...
 *****************************************************/
extern Std_ReturnType Rte_Call_Main_SWC_RP_Call_Subsystem_Call_Subsystem (const my_uint8* CAN_Frame);
#ifndef IN_RTE_C
#define Rte_Call_RP_Call_Subsystem_Call_Subsystem(CAN_Frame) \
	Rte_Call_Main_SWC_RP_Call_Subsystem_Call_Subsystem(CAN_Frame)
#endif
...
typedef Std_ReturnType (*FunctionPtr_Main_SWC_RP_Call_Subsystem_Call_Subsystem)(const my_uint8* CAN_Frame);
