...
{
	{
		...
		{PORT_PIN_IN,TRUE,PORT_A_PIN_6,PORT_PIN_MODE_PWM,STD_LOW,PORT_PIN_MODE_PWM,TRUE,TRUE,GPIO_Slew_Rate_10M,GPIO_Pin_Driven_Mode_PP},
		...
		{PORT_PIN_OUT,TRUE,PORT_A_PIN_9,PORT_PIN_MODE_CAN,STD_HIGH,PORT_PIN_MODE_CAN,TRUE,TRUE,GPIO_Slew_Rate_10M,GPIO_Pin_Driven_Mode_PP},
		{PORT_PIN_IN,TRUE,PORT_A_PIN_10,PORT_PIN_MODE_CAN,STD_LOW,PORT_PIN_MODE_CAN,TRUE,TRUE,GPIO_Slew_Rate_10M,GPIO_Pin_Driven_Mode_PP},
		...
		{PORT_PIN_OUT,TRUE,PORT_B_PIN_1,PORT_PIN_MODE_DIO,STD_LOW,PORT_PIN_MODE_DIO,TRUE,TRUE,GPIO_Slew_Rate_10M,GPIO_Pin_Driven_Mode_PP},
		...
		{PORT_PIN_OUT,TRUE,PORT_B_PIN_4,PORT_PIN_MODE_DIO,STD_LOW,PORT_PIN_MODE_DIO,TRUE,TRUE,GPIO_Slew_Rate_10M,GPIO_Pin_Driven_Mode_PP},
		...
		{PORT_PIN_OUT,TRUE,PORT_B_PIN_6,PORT_PIN_MODE_DIO,STD_LOW,PORT_PIN_MODE_DIO,TRUE,TRUE,GPIO_Slew_Rate_10M,GPIO_Pin_Driven_Mode_PP},
		...
		{PORT_PIN_OUT,TRUE,PORT_B_PIN_8,PORT_PIN_MODE_DIO,STD_LOW,PORT_PIN_MODE_DIO,TRUE,TRUE,GPIO_Slew_Rate_10M,GPIO_Pin_Driven_Mode_PP},
		...
		{PORT_PIN_OUT,TRUE,PORT_B_PIN_10,PORT_PIN_MODE_DIO,STD_LOW,PORT_PIN_MODE_DIO,TRUE,TRUE,GPIO_Slew_Rate_10M,GPIO_Pin_Driven_Mode_PP},
