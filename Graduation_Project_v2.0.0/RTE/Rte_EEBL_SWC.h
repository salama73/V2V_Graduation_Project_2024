 ...
 *****************************************************/
extern Std_ReturnType Rte_Call_EEBL_SWC_RP_Get_Distance_Call_Ultrasonic (my_uint16* Distance);
#ifndef IN_RTE_C
...
typedef Std_ReturnType (*FunctionPtr_EEBL_SWC_RP_Get_Distance_Call_Ultrasonic)(my_uint16* Distance);
