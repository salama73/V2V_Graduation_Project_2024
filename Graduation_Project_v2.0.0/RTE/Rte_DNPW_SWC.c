...
Std_ReturnType Rte_Call_DNPW_SWC_RP_Get_Distance_Call_Ultrasonic (my_uint16* Distance)
{
	Std_ReturnType __result = DNPW_SWC_RP_Get_Distance_Call_Ultrasonic_Buffer_retcode;
	if ( Rte_Call_DNPW_SWC_RP_Get_Distance_Call_Ultrasonic_Delegate != 0 ) {
		__result = Rte_Call_DNPW_SWC_RP_Get_Distance_Call_Ultrasonic_Delegate(Distance);
	}
