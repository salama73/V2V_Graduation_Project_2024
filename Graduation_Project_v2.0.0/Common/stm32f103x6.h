...
// USART1
#define USART1_BAES							0X40013800UL
// USART2
#define USART2_BAES							0X40004400UL
// USART3
#define USART3_BAES							0X40004800UL
//NVIC
...
#define USART1		((USART_TypeDef*)USART1_BAES)
#define USART2		((USART_TypeDef*)USART2_BAES)
#define USART3		((USART_TypeDef*)USART3_BAES)
//CAN_TX_mailbox
...
#define TIM3_ER_IRQ				(uint32)29//TIM3 global interrupt
#define USART1_IRQ				(uint32)37
#define USART2_IRQ				(uint32)38
#define USART3_IRQ				(uint32)39
//-*-*-*-*-*-*-*-*-*-*-*-
//NVIC Enable Macros:
//-*-*-*-*-*-*-*-*-*-*-*
...
#define NVIC_IRQ28_TIM3_Disable()							(NVIC_ICER0 |=1<<TIM3_ER_IRQ)
